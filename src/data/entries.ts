    ...
    "api": [
      {
        ...
        "note": {
          ...
          "ko": "the canonical implementation — free since GSAP 3.13"
        }
      },
      {
        "framework": "JS",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The random letters still spinning at the end while the rest has settled” is the churn — the not-yet-locked characters drawn from the scramble charset."
        },
        "prompt": {
          ...
          "ko": "the scramble's glyph churn: the still-randomizing characters (charset like \"!<>-_\\\\/[]{}\") that haven't reached their settle deadline yet"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      {
        ...
        "note": {
          ...
          "ko": "no duration — the physics decide when it stops"
        }
      },
      {
        "framework": "CSS",
        ...
        "note": {
          ...
          "ko": "a spring baked into keypoints — springs as pure CSS"
        }
      },
      {
        "framework": "React",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“Where it goes past the line and comes back” is the overshoot — damping controls how much of it survives."
        },
        "prompt": {
          "en": "the spring's overshoot: the travel past the resting position before settling — tune with damping (higher = less overshoot)",
          "ko": "the spring's overshoot: the travel past the resting position before settling — tune with damping (higher = less overshoot)"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "piecewise curves beyond beziers (springs, bounces); baseline since 2023"
        }
      },
      {
        "framework": "Motion",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The S-shaped graph in the animation editor” is the timing curve itself — time runs left to right, progress bottom to top."
        },
        "prompt": {
          "en": "the easing's timing curve: the cubic-bezier graph mapping time (x) to progress (y) — steep = fast, flat = slow",
          "ko": "the easing's timing curve: the cubic-bezier graph mapping time (x) to progress (y) — steep = fast, flat = slow"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "native (Grid Lanes): Safari 26; behind flags elsewhere in 2026 — pair with @supports"
        }
      },
      {
        "framework": "React",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The cards stack straight down with nothing lining up sideways” — each column packs independently, which is the whole trick."
        },
        "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The one big box among the small ones” is a spanning tile — a normal grid item told to take two columns and/or two rows."
        },
        "prompt": {
          ...
          "ko": "the bento grid's spanning tile: a grid item with grid-column: span 2 and grid-row: span 2 so it occupies a 2×2 block among single-cell tiles"
        }
      },
      {
        "id": "bento-gap",
        ...
        "description": {
          ...
          "ko": "“The even spacing between all the boxes” is the grid's gap — one value, never per-tile margins, which is why a bento looks machine-packed."
        },
        "prompt": {
          ...
          "ko": "the bento grid's gap: a single CSS gap value on the grid container providing every gutter, with no margins on the tiles themselves"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "Android/Material's name for the panel"
        }
      }
    ],
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The three stacked lines” are the hamburger button — a plain toggle whose aria-expanded tracks the drawer."
        },
        "prompt": {
          "en": "a hamburger button: three stacked 2px lines in a <button aria-expanded aria-controls> at the bar's left edge",
          "ko": "a hamburger button: three stacked 2px lines in a <button aria-expanded aria-controls> at the bar's left edge"
        }
      },
      {
        "id": "nav-drawer",
        ...
        "description": {
          ...
          "ko": "“The side menu that slides over the page” is the navigation drawer — an off-canvas <nav> panel above a scrim."
        },
        "prompt": {
          "en": "a navigation drawer: an off-canvas <nav> panel sliding from the left over a scrim, body scroll locked while open",
          "ko": "a navigation drawer: an off-canvas <nav> panel sliding from the left over a scrim, body scroll locked while open"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      {
        ...
        "note": {
          ...
          "ko": "the modern base layer for a lightbox"
        }
      },
      {
        "framework": "CSS",
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "ready-made lightbox libraries"
        }
      }
    ],
    "parts": [],
    ...
    "api": [
      {
        ...
        "note": {
          ...
          "ko": "the modern way: a transform loop over duplicated content"
        }
      },
      {
        "framework": "HTML",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The logos dissolving at both ends of the strip” is the edge fade — a mask, not a painted gradient."
        },
        "prompt": {
          ...
          "ko": "the marquee's edge fade: a mask-image linear-gradient on the strip container so items dissolve at both ends instead of clipping hard"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "claim a region; called from resetCursorRects()"
        }
      },
      {
        "framework": "SwiftUI",
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "the same shapes on the web: pointer, grab, not-allowed…"
        }
      }
    ],
    "parts": [],
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The yellow triangle over the app icon” is the alert icon — your app's icon, badged with the caution symbol when alertStyle is .warning or .critical."
        },
        "prompt": {
          "en": "the NSAlert icon — the app icon badged with the yellow caution triangle (NSAlert.icon, alertStyle .warning)",
          "ko": "the NSAlert icon — the app icon badged with the yellow caution triangle (NSAlert.icon, alertStyle .warning)"
        }
      },
      {
        "id": "message-text",
        ...
        "description": {
          ...
          "ko": "“The bold line” is messageText — the one-sentence summary, phrased as a question when the alert asks for a decision."
        },
        "prompt": {
          "en": "the bold headline of an NSAlert (NSAlert.messageText)",
          "ko": "the bold headline of an NSAlert (NSAlert.messageText)"
        }
      },
      {
        "id": "informative-text",
        ...
        "description": {
          ...
          "ko": "“The smaller gray text under the bold line” is informativeText — the consequences, spelled out in a sentence."
        },
        "prompt": {
          "en": "the smaller explanation line of an NSAlert (NSAlert.informativeText)",
          "ko": "the smaller explanation line of an NSAlert (NSAlert.informativeText)"
        }
      },
      {
        ...
        "description": {
          ...
          "ko": "“The don't ask me again checkbox” is the suppression button — enable it with showsSuppressionButton and read suppressionButton.state after the alert returns."
        },
        "prompt": {
          "en": "the “Don't ask me again” checkbox of an NSAlert (showsSuppressionButton = true, read suppressionButton.state)",
          "ko": "the “Don't ask me again” checkbox of an NSAlert (showsSuppressionButton = true, read suppressionButton.state)"
        }
      },
      {
        "id": "default-button",
        ...
        "description": {
          ...
          "ko": "“The blue button” is the default button — the first button added to the alert; it gets the accent color and the Return key."
        },
        "prompt": {
          "en": "the blue default button of an NSAlert — the first addButton(withTitle:), key equivalent Return",
          "ko": "the blue default button of an NSAlert — the first addButton(withTitle:), key equivalent Return"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The round dot you drag” is the knob — AppKit calls it the knob; the web calls the same thing a thumb."
        },
        "prompt": {
          "en": "the round draggable knob of an NSSlider (the web calls it the thumb)",
          "ko": "the round draggable knob of an NSSlider (the web calls it the thumb)"
        }
      },
      {
        "id": "filled-track",
        ...
        "description": {
          ...
          "ko": "“The blue part of the line before the knob” is the filled side of the track — it shows how far along the range the value sits."
        },
        "prompt": {
          "en": "the tinted leading portion of a slider track, from the minimum up to the knob (SwiftUI: Slider with .tint)",
          "ko": "the tinted leading portion of a slider track, from the minimum up to the knob (SwiftUI: Slider with .tint)"
        }
      },
      {
        "id": "track",
        ...
        "description": {
          ...
          "ko": "“The groove the dot slides along” is the track — the full range, end to end."
        },
        "prompt": {
          "en": "the full-width groove of a linear NSSlider that the knob travels along",
          "ko": "the full-width groove of a linear NSSlider that the knob travels along"
        }
      },
      {
        "id": "tick-marks",
        ...
        "description": {
          ...
          "ko": "“The little lines under the slider” are tick marks — with allowsTickMarkValuesOnly the knob only lands on them."
        },
        "prompt": {
          "en": "tick marks below an NSSlider (numberOfTickMarks, tickMarkPosition = .below), snapping via allowsTickMarkValuesOnly",
          "ko": "tick marks below an NSSlider (numberOfTickMarks, tickMarkPosition = .below), snapping via allowsTickMarkValuesOnly"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The colored area itself” is the swatch — it always displays the well's current color and is the click target for the quick picker."
        },
        "prompt": {
          "en": "the swatch area of an NSColorWell showing its current color (NSColorWell.color)",
          "ko": "the swatch area of an NSColorWell showing its current color (NSColorWell.color)"
        }
      },
      {
        "id": "panel-button",
        ...
        "description": {
          ...
          "ko": "“The little arrow segment next to the swatch” is the dedicated button the expanded style adds — it opens the full color panel."
        },
        "prompt": {
          "en": "the caret button attached to an expanded-style NSColorWell (colorWellStyle = .expanded) that opens NSColorPanel",
          "ko": "the caret button attached to an expanded-style NSColorWell (colorWellStyle = .expanded) that opens NSColorPanel"
        }
      },
      {
        ...
        "description": {
          ...
          "ko": "“The grid of color squares that pops up” is the expanded style's quick picker — swatches for fast choices, without the full panel."
        },
        "prompt": {
          "en": "the quick swatch-grid popover an expanded NSColorWell shows when the swatch is clicked",
          "ko": "the quick swatch-grid popover an expanded NSColorWell shows when the swatch is clicked"
        }
      },
      {
        "id": "eyedropper",
        ...
        "description": {
          ...
          "ko": "“The eyedropper that picks a color from anywhere on screen” is the system color sampler — one call: NSColorSampler().show { color in … }."
        },
        "prompt": {
          "en": "the system eyedropper for sampling a color from the screen (NSColorSampler().show { color in … })",
          "ko": "the system eyedropper for sampling a color from the screen (NSColorSampler().show { color in … })"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The word above the box” is the label — a real <label> tied to the input by for/id, so clicking it focuses the field."
        },
        "prompt": {
          "en": "a real <label for> element above the input, tied to it by for/id",
          "ko": "a real <label for> element above the input, tied to it by for/id"
        }
      },
      {
        ...
        "description": {
          ...
          "ko": "“The little red star” marks a required field — the asterisk is decoration; the input itself carries the required attribute."
        },
        "prompt": {
          "en": "the required-field asterisk beside the label, backed by the required attribute on the input",
          "ko": "the required-field asterisk beside the label, backed by the required attribute on the input"
        }
      },
      {
        "id": "placeholder",
        ...
        "description": {
          ...
          "ko": "“The gray text inside the box that disappears when you type” is the placeholder — an example or hint, never a substitute for the label."
        },
        "prompt": {
          "en": "the placeholder hint inside the input (placeholder attribute, styled via ::placeholder), used as a hint only",
          "ko": "the placeholder hint inside the input (placeholder attribute, styled via ::placeholder), used as a hint only"
        }
      },
      {
        "id": "helper-text",
        ...
        "description": {
          ...
          "ko": "“The small gray line under the field” is helper text — link it to the input with aria-describedby so screen readers announce it."
        },
        "prompt": {
          "en": "the helper/hint text below the input, linked with aria-describedby",
          "ko": "the helper/hint text below the input, linked with aria-describedby"
        }
      },
      {
        "id": "error-message",
        ...
        "description": {
          ...
          "ko": "“The red text under the box” is the validation message — pair the red border (aria-invalid, :user-invalid) with a message the field references."
        },
        "prompt": {
          ...
          "ko": "the inline validation error below the field: aria-invalid=\"true\" on the input, red border, and an error message linked via aria-describedby"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“Dot dot dot at the end of the line” — only kicks in alongside overflow: hidden and white-space: nowrap."
        },
        "prompt": {
          "en": "single-line truncation: overflow: hidden; white-space: nowrap; text-overflow: ellipsis",
          "ko": "single-line truncation: overflow: hidden; white-space: nowrap; text-overflow: ellipsis"
        }
      },
      {
        "id": "line-clamp",
        ...
        "description": {
          ...
          "ko": "“Show two lines then cut it off” is a line clamp — the ellipsis lands at the end of the last allowed line."
        },
        "prompt": {
          "en": "multi-line clamp: display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2; overflow: hidden",
          "ko": "multi-line clamp: display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 2; overflow: hidden"
        }
      },
      {
        ...
        "description": {
          ...
          "ko": "“The dots in the middle of a long file name” keep both ends readable — native on macOS (.byTruncatingMiddle); on the web it takes JS."
        },
        "prompt": {
          ...
          "ko": "middle truncation keeping the start and the file extension visible (macOS: lineBreakMode = .byTruncatingMiddle; web: JS string slicing)"
        }
      },
      {
        "id": "fade-out",
        ...
        "description": {
          ...
          "ko": "“The text fades out at the edge instead of dots” — a soft truncation done with a transparency mask, common in cards and code previews."
        },
        "prompt": {
          "en": "fade-out truncation: mask-image: linear-gradient(to right, black 70%, transparent) on a nowrap, overflow-hidden line",
          "ko": "fade-out truncation: mask-image: linear-gradient(to right, black 70%, transparent) on a nowrap, overflow-hidden line"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "deprecated; announce drag state and drop results with live regions instead"
        }
      },
      {
        "framework": "dnd-kit",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“Those kind of a 3x3 or 2x2” dots are a drag handle, also called a grip or grabber."
        },
        "prompt": {
          ...
          "ko": "a drag handle or grip on the draggable item (HTML draggable=\"true\" or @dnd-kit/core listeners): a compact 3×3 or 2×2 dot matrix that clearly marks where to grab"
        }
      },
      {
        "id": "resize-handles",
        ...
        "prompt": {
          ...
          "ko": "selection resize handles using pointer events: small square controls on the selected object's corners and edges that resize it without acting as drag handles"
        }
      },
      {
        "id": "drop-indicator",
        ...
        "prompt": {
          ...
          "ko": "a drop indicator during ondragover: a clearly visible insertion line between items at the exact position where the dragged item will land"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "a drop-target highlight during ondragover: tint the whole valid destination or its precise split zone before the item is dropped"
        }
      },
      {
        "id": "drag-preview",
        ...
        "description": {
          ...
          "ko": "The translucent copy that follows the pointer during a drag is the drag preview, often called the ghost."
        },
        "prompt": {
          ...
          "ko": "a drag preview or ghost (DataTransfer.setDragImage()): a lightweight translucent image of the dragged item that follows the pointer without obscuring the drop cues"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "name": {
          ...
          "ko": "Thematic break (horizontal rule)"
        },
        "api": "<hr>",
        "description": {
          "en": "“Above that line break” can mean a horizontal rule: an <hr> marking a real change of topic between sections of content.",
          "ko": "“Above that line break” can mean a horizontal rule: an <hr> marking a real change of topic between sections of content."
        },
        "prompt": {
          "en": "a semantic thematic break using HTML <hr>: a horizontal rule between two content sections whose subject or scene changes",
          "ko": "a semantic thematic break using HTML <hr>: a horizontal rule between two content sections whose subject or scene changes"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "a structural separator with role=\"separator\" between two groups of controls or interface regions, with aria-orientation=\"vertical\" when it is vertical"
        }
      },
      {
        ...
        "description": {
          ...
          "ko": "“Maybe add a vertical line divider” can be only decoration; use a CSS border with no separator semantics when it conveys no structure."
        },
        "prompt": {
          ...
          "ko": "a purely decorative divider drawn with a CSS border such as border-block-start or border-inline-start, with no <hr> element or separator role"
        }
      },
      {
        "id": "macos-separators",
        "name": {
          ...
          "ko": "macOS divider and separator item"
        },
        ...
        "description": {
          ...
          "ko": "In macOS UI, SwiftUI calls the visual line Divider, while a line between menu command groups is an NSMenuItem separator item."
        },
        "prompt": {
          ...
          "ko": "the native macOS cousin: SwiftUI Divider between view regions, or NSMenuItem.separator() specifically between related groups of menu commands"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the Mac window's title bar (NSWindow.titleVisibility): the top chrome containing the title, traffic lights, and optional unified toolbar"
        }
      },
      {
        "id": "drag-region",
        ...
        "prompt": {
          ...
          "ko": "the window drag region (NSWindow.isMovableByWindowBackground): an unobstructed title-bar area that moves the NSWindow when dragged"
        }
      },
      {
        "id": "window-title",
        ...
        "prompt": {
          ...
          "ko": "the window title (NSWindow.title): the document or screen name positioned in the title-bar chrome"
        }
      },
      {
        "id": "unified-toolbar",
        ...
        "prompt": {
          ...
          "ko": "a unified Mac toolbar (NSWindow.ToolbarStyle.unified) sharing the title bar's single row instead of sitting in a separate strip"
        }
      },
      {
        "id": "toolbar-item",
        ...
        "prompt": {
          ...
          "ko": "a native toolbar item (NSToolbarItem) placed with macOS toolbar spacing, validation, and overflow behavior"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "a title-bar accessory (NSTitlebarAccessoryViewController): a custom control strip attached to an edge of the NSWindow title bar, separate from NSToolbar"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the title-bar separator (NSWindow.titlebarSeparatorStyle): the native hairline between the title-bar or toolbar chrome and window content"
        }
      },
      {
        "id": "window-tabs",
        ...
        "description": {
          ...
          "ko": "Tabs in the window frame group separate document windows; they are not an NSTabView inside the content area."
        },
        "prompt": {
          ...
          "ko": "native window tabs (NSWindowTabGroup): a tab strip in the window frame that groups separate NSWindow documents, not an in-content NSTabView"
        }
      },
      {
        "id": "resize-edge",
        ...
        "prompt": {
          ...
          "ko": "the native resize edge and corner (NSWindow.StyleMask.resizable): the draggable window-frame boundary, including the bottom-right size-grip area"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "Each independently sized region on either side of the divider is a pane, represented by an NSSplitViewItem."
        },
        "prompt": {
          "en": "a split-view pane (NSSplitViewItem): one independently sized content region inside the NSSplitView",
          "ko": "a split-view pane (NSSplitViewItem): one independently sized content region inside the NSSplitView"
        }
      },
      {
        "id": "divider",
        "name": {
          ...
          "ko": "Split-view divider (splitter)"
        },
        ...
        "description": {
          ...
          "ko": "“The line between the two panes that I drag” is the split-view divider, also called a splitter."
        },
        "prompt": {
          ...
          "ko": "the draggable split-view divider or splitter (NSSplitView.dividerThickness) between two panes, with the native resize cursor and hit area"
        }
      },
      {
        "id": "sidebar-collapse",
        ...
        "prompt": {
          ...
          "ko": "native sidebar collapse behavior (NSSplitViewItem.collapseBehavior): the leading pane folds away while the adjacent pane expands into its space"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "a tracking separator toolbar item (NSTrackingSeparatorToolbarItem) aligned to the NSSplitView divider and moving horizontally with it"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "The control most people call a scrollbar is formally a scroller in AppKit."
        },
        "prompt": {
          "en": "the scroll view's scroller (NSScroller): the native macOS track-and-thumb control at the content edge",
          "ko": "the scroll view's scroller (NSScroller): the native macOS track-and-thumb control at the content edge"
        }
      },
      {
        "id": "knob",
        ...
        "description": {
          ...
          "ko": "“The little thumb you drag” is the scroller knob; its length reflects how much content is visible."
        },
        "prompt": {
          ...
          "ko": "the scroller knob or thumb (NSScroller.knobProportion): the draggable rounded piece whose length represents the visible fraction of content"
        }
      },
      {
        "id": "knob-slot",
        ...
        "description": {
          ...
          "ko": "The channel behind the knob is the knob slot, commonly called the scrollbar track."
        },
        "prompt": {
          "en": "the scroller knob slot or track (NSScroller.drawKnobSlot(in:highlight:)): the channel behind the draggable knob",
          "ko": "the scroller knob slot or track (NSScroller.drawKnobSlot(in:highlight:)): the channel behind the draggable knob"
        }
      },
      {
        "id": "scroller-style",
        ...
        "description": {
          ...
          "ko": "An overlay scroller fades over the content; a legacy scroller stays visible and takes up layout space."
        },
        "prompt": {
          ...
          "ko": "the scroller style (NSScroller.Style): overlay floats above content and fades when idle, while legacy remains visible in reserved space"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the search button (NSSearchFieldCell.searchButtonCell): the leading magnifying-glass control inside the NSSearchField"
        }
      },
      {
        "id": "cancel-button",
        ...
        "prompt": {
          ...
          "ko": "the cancel button (NSSearchFieldCell.cancelButtonCell): the trailing x control that appears for a nonempty query and clears it"
        }
      },
      {
        "id": "recents-menu",
        ...
        "prompt": {
          ...
          "ko": "the recent-searches menu (NSSearchFieldCell.searchMenuTemplate): a menu from the search button listing saved queries and Clear Recents"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the save panel's name field (NSSavePanel.nameFieldStringValue): the editable filename box above the browser"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the save panel's disclosure expansion button (NSSavePanel.isExpanded): the small control that reveals or hides the full file browser"
        }
      },
      {
        "id": "format-popup",
        ...
        "prompt": {
          ...
          "ko": "the save panel's format pop-up (NSSavePanel.allowedContentTypes): the native file-type selector beneath the filename field"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "an NSTokenField.TokenStyle token capsule wrapping one recognized value inside the field"
        }
      },
      {
        "id": "selected-token",
        ...
        "prompt": {
          ...
          "ko": "the selected NSTokenField token with its native highlight, ready for keyboard deletion or editing"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "no single native SwiftUI equivalent"
        }
      }
    ],
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the NSComboButton primary action region, with the main label performing the default action immediately"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the separate NSComboButton menu disclosure region, a narrow attached chevron target that opens the related NSMenu"
        }
      },
      {
        "id": "split-divider",
        ...
        "prompt": {
          ...
          "ko": "the divider in NSComboButton.Style.split that visibly separates the primary action target from the arrow target"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the filled level of an NSLevelIndicator, sized from its doubleValue within the configured range"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the NSLevelIndicator.warningValue threshold where the capacity fill changes to its native warning color"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the NSLevelIndicator.criticalValue threshold where the capacity fill takes its native critical color"
        }
      },
      {
        "id": "rating-symbol",
        ...
        "prompt": {
          ...
          "ko": "the repeated rating symbols in NSLevelIndicator.Style.rating, filled through the current rating value"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“Each folder opening in a new column” is a path column in an NSBrowser."
        },
        "prompt": {
          "en": "an NSBrowser path column that keeps one visible level of the selected hierarchy",
          "ko": "an NSBrowser path column that keeps one visible level of the selected hierarchy"
        }
      },
      {
        "id": "branch-indicator",
        ...
        "prompt": {
          ...
          "ko": "the branch indicator on a non-leaf NSBrowserCell, showing that selecting the row will reveal another column"
        }
      },
      {
        "id": "selected-path",
        ...
        "prompt": {
          ...
          "ko": "the NSBrowser selected path, with one highlighted ancestor row preserved in each visible column"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "when supplied hierarchical children"
        }
      }
    ],
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the native disclosure triangle supplied by NSOutlineView for a row with children"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the NSOutlineView.level(forItem:) indentation that makes each child depth visible"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the NSTableRowView.isSelected highlight spanning the selected outline row"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "a horizontal-dots meatball button (button[aria-haspopup=\"menu\"]): three dots in one row opening the contextual Overflow or More menu"
        }
      },
      {
        "id": "kebab",
        ...
        "prompt": {
          ...
          "ko": "a vertical-dots kebab menu button (button[aria-haspopup=\"menu\"]): three stacked dots opening an overflow menu of secondary actions"
        }
      },
      {
        "id": "hamburger",
        ...
        "prompt": {
          ...
          "ko": "a three-line hamburger menu button (button[aria-controls]): the navigation trigger that opens a side drawer, not an overflow actions menu"
        }
      },
      {
        "id": "command-ellipsis",
        ...
        "prompt": {
          ...
          "ko": "a command ellipsis in the label (<button>Open…</button>): the single ellipsis character means more input is required before the command completes, not that the button opens an overflow menu"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "one right-side icon, macOS 13+"
        }
      }
    ],
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The File Edit View menus at the top” have a real name: the app's main menu."
        },
        "prompt": {
          "en": "the app's main menu in the macOS menu bar (NSApp.mainMenu): the bold app-name menu followed by File, Edit, View",
          "ko": "the app's main menu in the macOS menu bar (NSApp.mainMenu): the bold app-name menu followed by File, Edit, View"
        }
      },
      {
        "id": "menu-bar-extra",
        "name": {
          ...
          "ko": "Menu bar extra (status item)"
        },
        "api": "NSStatusItem",
        "description": {
          "en": "“The little icon near the clock” is a status item in NSStatusBar.system; SwiftUI calls it MenuBarExtra.",
          "ko": "“The little icon near the clock” is a status item in NSStatusBar.system; SwiftUI calls it MenuBarExtra."
        },
        "prompt": {
          "en": "a menu bar extra — an NSStatusItem on the right side of the macOS menu bar (SwiftUI: MenuBarExtra)",
          "ko": "a menu bar extra — an NSStatusItem on the right side of the macOS menu bar (SwiftUI: MenuBarExtra)"
        }
      },
      {
        "id": "template-icon",
        ...
        "description": {
          ...
          "ko": "The monochrome glyph that recolors itself for light/dark menu bars — a template image, usually an SF Symbol."
        },
        "prompt": {
          ...
          "ko": "the status item's icon must be a template image (NSImage.isTemplate = true, ideally an SF Symbol) so macOS recolors it automatically for light and dark menu bars"
        }
      },
      {
        ...
        "description": {
          ...
          "ko": "The pale rounded pill behind the icon while its menu or popover is open — the hardest-to-describe pixel on this page."
        },
        "prompt": {
          ...
          "ko": "the status item's highlighted state: the pale rounded background behind the menu bar icon while its menu is open (NSStatusBarButton.isHighlighted)"
        }
      },
      {
        "id": "menu",
        ...
        "description": {
          ...
          "ko": "“The dropdown” from a menu bar icon is an NSMenu — translucent, rounded, vibrancy-backed."
        },
        "prompt": {
          "en": "the NSMenu dropdown attached to the status item",
          "ko": "the NSMenu dropdown attached to the status item"
        }
      },
      {
        "id": "menu-item",
        ...
        "prompt": {
          ...
          "ko": "the menu item's selection highlight — the accent-colored rounded bar behind an NSMenuItem while it's hovered/selected"
        }
      },
      {
        "id": "separator",
        ...
        "prompt": {
          ...
          "ko": "a separator item (NSMenuItem.separator()) dividing the menu into groups"
        }
      },
      {
        "id": "key-equivalent",
        ...
        "description": {
          ...
          "ko": "“The ⌘Q text on the right side of a menu option” is the item's key equivalent."
        },
        "prompt": {
          "en": "the keyboard shortcut shown at the right edge of the menu item (its key equivalent, NSMenuItem.keyEquivalent, e.g. ⌘Q)",
          "ko": "the keyboard shortcut shown at the right edge of the menu item (its key equivalent, NSMenuItem.keyEquivalent, e.g. ⌘Q)"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the native selection highlight behind the active NSMenuItem in a contextual NSMenu"
        }
      },
      {
        "id": "separator-item",
        ...
        "prompt": {
          ...
          "ko": "an NSMenuItem.separator() dividing related groups in the context menu"
        }
      },
      {
        "id": "key-equivalent",
        ...
        "description": {
          ...
          "ko": "“The keyboard shortcut text on the right” is the item's key equivalent."
        },
        "prompt": {
          "en": "the NSMenuItem.keyEquivalent aligned at the trailing edge of a context-menu item, such as ⌘C",
          "ko": "the NSMenuItem.keyEquivalent aligned at the trailing edge of a context-menu item, such as ⌘C"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the trailing submenu indicator on an NSMenuItem whose submenu opens beside the context menu"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "a native disclosure indicator using NSButton.BezelStyle.disclosure beside the expandable label"
        }
      },
      {
        "id": "collapsed-state",
        ...
        "prompt": {
          ...
          "ko": "the collapsed DisclosureGroup.isExpanded = false state, with the indicator pointing sideways and children hidden"
        }
      },
      {
        "id": "expanded-state",
        ...
        "prompt": {
          ...
          "ko": "the expanded DisclosureGroup.isExpanded = true state, with the disclosure indicator pointing down above the revealed children"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "bounces the Dock icon; separate from the badge"
        }
      },
      {
        "framework": "AppKit",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The red number bubble on the app icon” is the Dock tile's badge label."
        },
        "prompt": {
          "en": "the NSDockTile.badgeLabel as a compact red count badge over the Dock icon's upper-right corner",
          "ko": "the NSDockTile.badgeLabel as a compact red count badge over the Dock icon's upper-right corner"
        }
      },
      {
        "id": "attention-bounce",
        ...
        "description": {
          ...
          "ko": "“The app icon jumping in the Dock” is an attention bounce, not part of the badge."
        },
        "prompt": {
          "en": "an NSApplication.requestUserAttention(_:) Dock-icon bounce used separately from NSDockTile.badgeLabel",
          "ko": "an NSApplication.requestUserAttention(_:) Dock-icon bounce used separately from NSDockTile.badgeLabel"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the NSWindow.firstResponder control that currently receives keyboard input"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "a trailing inspector column created with View.inspector(isPresented:content:), beside rather than over the main content"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "a DisclosureGroup section disclosure inside the inspector, with its chevron aligned to the section heading"
        }
      },
      {
        "id": "column-divider",
        ...
        "prompt": {
          ...
          "ko": "the resizable divider before the trailing NSSplitViewItem inspector column"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "an NSPanel at NSWindow.Level.floating, remaining above its related document windows"
        }
      },
      {
        "id": "hud-chrome",
        ...
        "description": {
          ...
          "ko": "“The dark translucent heads-up-display frame” is HUD chrome."
        },
        "prompt": {
          "en": "the dark translucent NSWindow.StyleMask.hudWindow chrome around an auxiliary NSPanel",
          "ko": "the dark translucent NSWindow.StyleMask.hudWindow chrome around an auxiliary NSPanel"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the NSPopover anchor arrow from show(relativeTo:of:preferredEdge:), pointing precisely at its source control"
        }
      },
      {
        "id": "positioning-rect",
        ...
        "prompt": {
          ...
          "ko": "the positioning rect passed to NSPopover.show(relativeTo:of:preferredEdge:), anchoring the bubble to the intended part of the source view"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      {
        ...
        "note": {
          ...
          "ko": "a selection control when pullsDown is false"
        }
      },
      {
        "framework": "AppKit",
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the NSPopUpButton.titleOfSelectedItem current-value label visible while the selection control is closed"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the menu indicator on an NSPopUpButton with pullsDown = true, signaling that the fixed-label button opens commands"
        }
      },
      {
        "id": "editable-field",
        ...
        "prompt": {
          ...
          "ko": "the editable NSComboBox value field, visually joined to its suggestions-list disclosure button"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the NSMenuItem.state checkmark beside the current value in an open NSPopUpButton menu"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the NSSegmentedControl.selectedSegment with the native persistent selected fill"
        }
      },
      {
        "id": "segment-divider",
        ...
        "prompt": {
          ...
          "ko": "the native divider between adjacent choices inside one NSSegmentedControl"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "app-modal alternative, not a sheet"
        }
      }
    ],
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The darkened area behind the sheet” is the dimming layer that marks the parent surface as temporarily unavailable."
        },
        "prompt": {
          ...
          "ko": "the sheet's dimming layer (View.sheet(isPresented:content:)): the translucent dark overlay over the blocked parent surface behind the presentation"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "the standard AppKit list appearance"
        }
      },
      {
        "framework": "SwiftUI",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "The spacious, vibrancy-aware Finder-like treatment of the rows is AppKit's source-list style."
        },
        "prompt": {
          ...
          "ko": "the native source-list style (NSTableView.Style.sourceList): Finder-like sidebar rows over a translucent background with system spacing"
        }
      },
      {
        "id": "section-header",
        ...
        "description": {
          ...
          "ko": "The small emphasized label dividing destinations into groups such as Favorites or iCloud is a section header."
        },
        "prompt": {
          ...
          "ko": "a sidebar section header (NSOutlineViewDelegate.outlineView(_:isGroupItem:)): the non-destination group label above a cluster of source-list rows"
        }
      },
      {
        "id": "selection-pill",
        ...
        "prompt": {
          ...
          "ko": "the sidebar selection pill (NSTableRowView.isSelected): the accent-tinted rounded background behind the active source-list row"
        }
      },
      {
        "id": "sidebar-toggle",
        ...
        "prompt": {
          ...
          "ko": "the sidebar toggle toolbar button (NSSplitViewController.toggleSidebar(_:)): the standard split-rectangle icon that collapses or reveals the leading sidebar"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the upper increment button of an NSStepper, increasing the bound value by NSStepper.increment"
        }
      },
      {
        "id": "decrement-button",
        ...
        "prompt": {
          ...
          "ko": "the lower decrement button of an NSStepper, reducing the bound value by NSStepper.increment"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "a native toolbar item (NSToolbarItem): one action, field, group, or flexible space placed with standard macOS toolbar behavior"
        }
      },
      {
        "id": "item-label",
        ...
        "prompt": {
          ...
          "ko": "the toolbar item label (NSToolbarItem.label): the action name shown with the icon in icon-and-text display mode"
        }
      },
      {
        "id": "overflow-chevron",
        ...
        "prompt": {
          ...
          "ko": "the toolbar overflow chevron (NSToolbarItem.visibilityPriority): the trailing » control that collects toolbar items that no longer fit"
        }
      },
      {
        "id": "title-bar-separator",
        ...
        "prompt": {
          ...
          "ko": "the title-bar separator style (NSWindow.titlebarSeparatorStyle): the automatic, line, shadow, or none boundary between unified toolbar chrome and window content"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "closeButton, miniaturizeButton, and zoomButton"
        }
      },
      {
        "framework": "AppKit",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "The red control shows an x on group hover and closes the window rather than necessarily quitting the app."
        },
        "prompt": {
          ...
          "ko": "the red close button (NSWindow.ButtonType.closeButton): the left traffic light with an x hover glyph that closes the NSWindow"
        }
      },
      {
        "id": "minimize-button",
        ...
        "prompt": {
          ...
          "ko": "the yellow minimize button (NSWindow.ButtonType.miniaturizeButton): the middle traffic light with a minus hover glyph that sends the window to the Dock"
        }
      },
      {
        "id": "zoom-button",
        ...
        "description": {
          ...
          "ko": "The green control normally enters full screen; Option-click invokes the traditional window Zoom behavior instead."
        },
        "prompt": {
          ...
          "ko": "the green zoom button (NSWindow.ButtonType.zoomButton): show its full-screen hover glyph, enter full screen normally, and perform traditional window Zoom on Option-click"
        }
      },
      {
        "id": "dirty-document",
        ...
        "prompt": {
          ...
          "ko": "the dirty-document dot (NSWindow.isDocumentEdited): the dark center mark inside the red close button indicating unsaved changes"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "an NSVisualEffectView.Material layer providing the adaptive translucent background for the surface"
        }
      },
      {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The corner where all the little messages stack” is the toast viewport."
        },
        "prompt": {
          "en": "the shadcn/ui Toaster viewport anchored to a consistent screen corner for the toast stack",
          "ko": "the shadcn/ui Toaster viewport anchored to a consistent screen corner for the toast stack"
        }
      },
      {
        "id": "status-message",
        ...
        "description": {
          ...
          "ko": "“The saved successfully text that appears by itself” is the toast's status message."
        },
        "prompt": {
          "en": "the concise role=\"status\" message inside the toast, announced politely without moving focus",
          "ko": "the concise role=\"status\" message inside the toast, announced politely without moving focus"
        }
      },
      {
        "id": "toast-action",
        ...
        "description": {
          ...
          "ko": "“The Undo button inside the temporary message” is the toast action."
        },
        "prompt": {
          "en": "a shadcn/ui ToastAction inside the toast for one safe, time-sensitive follow-up such as Undo",
          "ko": "a shadcn/ui ToastAction inside the toast for one safe, time-sensitive follow-up such as Undo"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the <dialog> modal surface centered in the top layer above its backdrop"
        }
      },
      {
        "id": "scrim",
        ...
        "prompt": {
          ...
          "ko": "the <dialog>::backdrop scrim covering and dimming the page behind the modal surface"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the popovertarget overlay trigger that owns and anchors the opened surface"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the selection highlight behind the active role=\"menuitem\" in a keyboard-navigable dropdown menu"
        }
      },
      {
        "id": "tooltip-arrow",
        ...
        "prompt": {
          ...
          "ko": "the Radix Tooltip.Arrow pointing from the role=\"tooltip\" hint back to its trigger"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the <dialog>::backdrop dim layer covering the entire viewport behind the modal"
        }
      },
      {
        "id": "backdrop-blur",
        ...
        "prompt": {
          ...
          "ko": "a CSS backdrop-filter blur applied to the scrim so the underlying page softens without blurring the modal"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the scrim's light-dismiss area calling HTMLDialogElement.close() only when the click lands outside the dialog surface"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "a shadcn/ui Skeleton block matching the final content's exact geometry to prevent layout shift"
        }
      },
      {
        "id": "skeleton-line",
        ...
        "prompt": {
          ...
          "ko": "a shadcn/ui Skeleton text line with varied natural widths matching the eventual copy layout"
        }
      },
      {
        "id": "shimmer-sweep",
        ...
        "prompt": {
          ...
          "ko": "a subtle CSS @keyframes shimmer sweep traveling across the skeleton blocks while aria-busy remains true"
        }
      },
      {
        "id": "spinner-track",
        ...
        "prompt": {
          ...
          "ko": "a role=\"status\" indeterminate spinner with a quiet circular track and one contrasting rotating arc"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the role=\"combobox\" text input controlling the suggestions popup and retaining DOM focus"
        }
      },
      {
        "id": "listbox-popup",
        ...
        "prompt": {
          ...
          "ko": "the role=\"listbox\" suggestions popup anchored directly beneath the combobox input"
        }
      },
      {
        "id": "active-option",
        ...
        "prompt": {
          ...
          "ko": "the aria-activedescendant active option, visibly highlighted while DOM focus remains in the combobox input"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the checkmark beside a role=\"option\" with aria-selected=\"true\" in the combobox listbox"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The search field at the top of the ⌘K menu” is the command input."
        },
        "prompt": {
          "en": "the shadcn/ui CommandInput at the top of the command palette, filtering commands as the user types",
          "ko": "the shadcn/ui CommandInput at the top of the command palette, filtering commands as the user types"
        }
      },
      {
        "id": "command-group",
        ...
        "prompt": {
          ...
          "ko": "a shadcn/ui CommandGroup with a quiet heading above a related set of command items"
        }
      },
      {
        "id": "active-command",
        ...
        "description": {
          ...
          "ko": "“The result with the highlight that Enter will run” is the active command."
        },
        "prompt": {
          "en": "the active shadcn/ui CommandItem with a full-row selection highlight showing what Enter will execute",
          "ko": "the active shadcn/ui CommandItem with a full-row selection highlight showing what Enter will execute"
        }
      },
      {
        "id": "command-shortcut",
        ...
        "description": {
          ...
          "ko": "“The ⌘ letters aligned on the right of an action” are the command shortcut."
        },
        "prompt": {
          "en": "the shadcn/ui CommandShortcut aligned at the trailing edge of its command item",
          "ko": "the shadcn/ui CommandShortcut aligned at the trailing edge of its command item"
        }
      }
    ],
    "prompt": {
    ...
    "api": [
      ...
      },
      {
        ...
        "note": {
          ...
          "ko": "groups details elements so only one is open"
        }
      },
      {
        "framework": "Radix",
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The FAQ question you click to open the answer” is the disclosure trigger."
        },
        "prompt": {
          "en": "the <summary> disclosure trigger spanning the accordion heading row",
          "ko": "the <summary> disclosure trigger spanning the accordion heading row"
        }
      },
      {
        "id": "disclosure-indicator",
        ...
        "prompt": {
          ...
          "ko": "the <summary>::marker disclosure indicator rotating between the closed and open states"
        }
      },
      {
        "id": "disclosure-panel",
        ...
        "prompt": {
          ...
          "ko": "the <details> disclosure panel revealed directly beneath its summary heading"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the role=\"tablist\" row containing the peer tab labels as one keyboard-navigation unit"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the active-tab indicator under the role=\"tab\" with aria-selected=\"true\", moving smoothly between labels"
        }
      },
      {
        "id": "tab-panel",
        ...
        "prompt": {
          ...
          "ko": "the role=\"tabpanel\" content region linked to its selected tab by aria-labelledby"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the shadcn/ui Badge anchor, with the compact count overlapping its parent icon's upper corner"
        }
      },
      {
        "id": "badge-count",
        ...
        "prompt": {
          ...
          "ko": "the compact count inside a shadcn/ui Badge, using a circular shape for one digit and a capsule for longer counts"
        }
      },
      {
        ...
        "description": {
          ...
          "ko": "“The little x inside the filter pill” is the chip's remove button."
        },
        "prompt": {
          "en": "the trailing <button aria-label> remove affordance inside a dismissible chip",
          "ko": "the trailing <button aria-label> remove affordance inside a dismissible chip"
        }
      },
      {
        ...
        "description": {
          ...
          "ko": "“The filter pill that stays filled after I click it” is the selected chip state."
        },
        "prompt": {
          "en": "the aria-pressed selected state of an interactive chip, with a persistent filled treatment",
          "ko": "the aria-pressed selected state of an interactive chip, with a persistent filled treatment"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "an aria-hidden=\"true\" decorative breadcrumb separator between hierarchy links"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the final breadcrumb marked aria-current=\"page\", styled as the current location rather than a link"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "a BreadcrumbEllipsis standing in for low-value middle ancestors while root and current page remain visible"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the CSS top inset defining the threshold where a position: sticky element becomes pinned"
        }
      },
      {
        "id": "scroll-container",
        ...
        "prompt": {
          ...
          "ko": "the nearest scrolling container that bounds the position: sticky element's travel"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "description": {
          ...
          "ko": "“The blue line around the button after I press Tab” is the focus outline."
        },
        "prompt": {
          "en": "a high-contrast CSS outline around the :focus-visible control",
          "ko": "a high-contrast CSS outline around the :focus-visible control"
        }
      },
      {
        "id": "outline-offset",
        ...
        "prompt": {
          ...
          "ko": "a CSS outline-offset leaving a visible gap between the :focus-visible ring and the control edge"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "an aria-hidden=\"true\" empty-state illustration that reinforces the missing-content state without becoming the label"
        }
      },
      {
        "id": "recovery-action",
        ...
        "prompt": {
          ...
          "ko": "the primary <button> recovery action in the empty state, resolving why the view has no content"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the Radix HoverCardTrigger reference that reveals its preview from both hover and keyboard focus"
        }
      },
      {
        "id": "preview-content",
        ...
        "prompt": {
          ...
          "ko": "the Radix HoverCardContent preview surface with richer passive details than a tooltip"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the circular thumb inside a role=\"switch\" control, sliding to the checked side when on"
        }
      },
      {
        "id": "switch-track",
        ...
        "prompt": {
          ...
          "ko": "the capsule-shaped track behind a role=\"switch\" thumb, changing fill with the checked state"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the native checkmark inside a checked <input type=\"checkbox\">"
        }
      },
      {
        ...
        "prompt": {
          ...
          "ko": "the centered selection dot inside the checked <input type=\"radio\"> of a same-name group"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "the role=\"radio\" toggle with aria-checked=\"true\", using a persistent selected fill"
        }
      },
      {
        "id": "segment-divider",
        ...
        "prompt": {
          ...
          "ko": "the divider between adjacent Radix ToggleGroup items inside one connected control"
        }
      }
    ],
    "prompt": {
    ...
    "parts": [
      {
        ...
        "prompt": {
          ...
          "ko": "an NSImage.isTemplate menu bar icon that macOS recolors automatically against light and dark menu bars"
        }
      },
      {
        "id": "highlighted-state",
        ...
        "prompt": {
          ...
          "ko": "the NSStatusBarButton.isHighlighted state: the pale rounded background behind the menu bar icon for as long as its surface is open"
        }
      },
      {
        "id": "attached-surface",
        ...
        "prompt": {
          ...
          "ko": "the NSStatusItem.menu or attached NSPopover opened directly beneath the status item"
        }
      }
    ],
    "prompt": {
