...
export const EntryDetailView: React.FC = () => {
  ...
  const relatedEntries = (entry.related || [])
    .map((rSlug) => ENTRIES.find((e) => e.slug === rSlug))
    .filter(Boolean);
        ...
        <section className="sect">
          ...
          <div className="rel-grid">
            {relatedEntries.map((re) => (
              <Link key={re!.slug} className="rel-card" to={`/${re!.platform}/${re!.slug}`}>
